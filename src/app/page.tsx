        ...
        <ScrollReveal>
          <div className="bg-white rounded-card p-8 md:p-10 shadow-sm">
            ...
            <p className="text-body text-brand-dark leading-relaxed">
              Nascemos do desejo de criar um ambiente onde cada cliente se sinta
              verdadeiramente única e acolhida em todos os detalhes. Aqui,
              trabalhamos com dedicação para realçar a beleza natural que já
              existe em você.
            </p>
          </div>
        </ScrollReveal>
      ...
      >
        <div className="max-w-[1440px] mx-auto grid grid-cols-1 lg:grid-cols-[1fr_2fr] gap-12 lg:gap-16 items-start">
          <div className="flex flex-col text-center lg:text-left lg:sticky lg:top-32">
            ...
            <p className="font-sans text-body text-text-muted max-w-xs mx-auto lg:mx-0">
              Especialistas em fazer você se sentir bem, do jeito que você
              merece.
            </p>
          </div>
      ...
      >
        ...
        <ScrollReveal>
          <div className="flex flex-wrap justify-center gap-8">
            <div className="w-[270px] flex flex-col items-center text-center bg-review rounded-[24px] p-8 shadow-sm transition-transform duration-300 hover:scale-105">
      ...
      >
        <div className="max-w-[1440px] mx-auto flex flex-col items-center">
          ...
          <div className="w-full grid grid-cols-1 lg:grid-cols-[1fr_320px_1fr] gap-12 lg:gap-16 items-center">
            ...
            <div className="flex justify-center items-center sm:order-1 lg:order-2">
               <FeatureSlideshow />
            </div>

            <div className="flex flex-col gap-10 order-3">

              <div className="flex flex-col lg:flex-row items-center justify-center lg:justify-start gap-3 lg:gap-5 text-center lg:text-left">
