    ...
    <main className="min-h-screen flex flex-col">
      ...
      >
        ...
        <div className="flex flex-wrap justify-center gap-8">
          <div className="w-[270px] flex flex-col items-center text-center bg-white rounded-[24px] p-8 shadow-sm border border-brand-warm">
            ...
            <p className="text-[14px] text-brand-dark leading-relaxed mb-6 flex-grow">
              ...
              expectativas, com profissionais atenciosas e com preço acessível.
              [...] Já indiquei para a minha família e com certeza voltarei.”
            </p>
          ...
          <div className="w-[270px] flex flex-col items-center text-center bg-white rounded-[24px] p-8 shadow-sm border border-brand-warm">
            ...
            <p className="text-[14px] text-brand-dark leading-relaxed mb-6 flex-grow">
              ...
              <b>sinto que estou nas mãos certas e confio de olhos fechados</b>.
      ...
      {/* Features */}
      <section className="py-22 px-6 w-full max-w-7xl mx-auto">
